...
@MapperScan({
    "com.lxh.personal.common.mybatis.dao", "com.lxh.personal.commerce.mybatis.dao"
})
public class SessionFactoryConfig {
    ...
    protected Resource[] getResources()
        ...
        Resource[] resources = resolver.getResources("classpath*:com/lxh/personal/common/mybatis/mapper/*.xml");
        Resource[] dest = resolver.getResources("classpath*:com/lxh/personal/commerce/mybatis/mapper/*.xml");
