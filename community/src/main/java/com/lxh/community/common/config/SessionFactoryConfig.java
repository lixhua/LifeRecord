package com.lxh.community.common.config;
...
@MapperScan({
    "com.lxh.community.common.mybatis.dao", "com.lxh.community.commerce.mybatis.dao"
})
public class SessionFactoryConfig {
    ...
    protected Resource[] getResources()
        ...
        Resource[] resources = resolver.getResources("classpath*:com/lxh/community/common/mybatis/mapper/*.xml");
        Resource[] dest = resolver.getResources("classpath*:com/lxh/community/commerce/mybatis/mapper/*.xml");
